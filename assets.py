...
assets = {
    'Forex': [['EURUSD', 'EURAUD', 'EURSEK', 'GBPJPY', 'GBPCAD', 'GBPUSD', 'USDCAD', 'USDJPY', 'AUDJPY', 
            'AUDUSD', 'CHFZAR', 'CHFCNH', 'CHFCZK', 'CHFHUF', 'CHFHUF', 'CHFNOK', 'CHFPLN', 'CHFTRY',
            'EURCNH', 'EURJPY', 'EURGBP', 'EURAUD', 'EURCAD', 'USDCNH', 'CNHJPY', 'CADJPY', 'GBPCNH', 
            'GBPAUD', 'AUDCNH', 'CADCNH',], 'IDEALPRO', 'Forex'], 
    'CFD': [['IBUS500', 'IBUST100', 'IBGB100', 'IBDE30', 'IBFR40', 'IBJP225', 'IBHK50', 'IBAU200', ], 'SMART', 'CFD'],
